...
import { TakeUntilExample } from './take-until';

describe('TakeUntilExample', () => {
  let example: TakeUntilExample;
  ...
  beforeEach(() => {
    ...
    example = TestBed.inject(TakeUntilExample);
  ...
  describe('desktop', () => {
    ...
    describe('example', () => {
      ...
      it('has expected source stream nodes', () => {
        ...
        expect(positions[1]).toBeObservable(cold('0', [[88, 158]]));
      });
  ...
  describe('mobile', () => {
    ...
    const two = '   -----a-|';
    const output = 'A-B-C|';
    const outputValues = { A: '1', B: '2', C: '3' };
    ...
    describe('example', () => {
      ...
      it('has expected source stream nodes', () => {
        ...
        expect(positions[1]).toBeObservable(cold('0', [[58, 78]]));
      });

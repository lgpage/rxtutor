...
describe('FinalizeExample', () => {
  let example: FinalizeExample;
  ...
  beforeEach(() => {
    ...
    example = TestBed.inject(FinalizeExample);
  ...
  describe('desktop', () => {
    ...
    const outputValues = { A: '1', B: '2', C: '3', D: '4' };
  ...
  describe('mobile', () => {
    ...
    describe('example', () => {
      ...
      it('has expected source stream nodes', () => {
        ...
        expect(positions[0]).toBeObservable(cold('0', [[8, 28, 48, 78]]));
      });
    });

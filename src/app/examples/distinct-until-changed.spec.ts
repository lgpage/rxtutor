...
import { DistinctUntilChangedExample } from './distinct-until-changed';

describe('DistinctUntilChangedExample', () => {
  let example: DistinctUntilChangedExample;
  ...
  beforeEach(() => {
    ...
    example = TestBed.inject(DistinctUntilChangedExample);
